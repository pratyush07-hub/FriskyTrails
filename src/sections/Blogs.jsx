...
const Blogs = () => {
  ...
  return (
    <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto py-2 ">
      {/* Perfect Responsive Heading */}
      <h2
className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-10 sm:mb-14 md:mb-12 lg:mb-20 leading-tight tracking-tight"
