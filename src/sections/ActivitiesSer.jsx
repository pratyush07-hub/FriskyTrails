...
import HillImage from "/services/activities.webp";
...
const ActivitiesSer = () => {
  return (
   ...
   <div className="min-h-screen mt-12 md:mt-20 w-full">
        {/* Banner Section */}
        <div
          className="h-[40vh] sm:h-[50vh] md:h-[62vh] w-full"
          style={{
        ...
        <div className="min-h-[70vh] w-full flex items-center justify-center px-4">
          ...
          >
            <h1 className="text-white text-2xl text-center sm:text-3xl md:text-4xl font-semibold">
              Loved For Experiences!
            </h1>
