  ...
  return (
    <>
      <div className="relative h-screen w-full flex flex-col items-center justify-center">
        <h3 className="text-center text-[rgb(255,99,33)] pt-10 md:pt-20 font-semibold text-lg md:text-xl">
          Customer's Feedback
        </h3>
        ...
        <div className="relative h-auto md:h-[80vh] w-full flex items-center justify-center">
          <div className="absolute w-40 md:w-80 h-40 md:h-80 bg-[url('/images/circle.avif')] bg-no-repeat bg-center bg-contain mr-20 md:mr-45 mt-4 md:mt-8"></div>

          <div className="absolute w-40 md:w-80 h-40 md:h-80 bg-[url('/images/dots.png')] bg-no-repeat bg-center bg-contain translate-x-20 md:translate-x-140 translate-y-10 md:translate-y-30"></div>
          ...
          <div className="relative z-10 flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10">
              {data.map((data, index) => (
                <div
                  key={index}
                  className="card h-auto md:h-[30vh] w-full md:w-[40vw] bg-white shadow rounded-xl flex flex-col md:flex-row"
                >
                  ...
                  <div className="w-full md:w-[80%]">
                    <div className="flex justify-between">
                      <div>
                        <h1 className="text-xl md:text-2xl font-bold mt-4 md:mt-6">
                          {data.name}
                        </h1>
                      ...
                      <div>
                        <h1 className="text-xl md:text-2xl mt-4 md:mt-10 mr-4 md:mr-8">
                          ⭐⭐⭐⭐⭐
                        </h1>
                      </div>
                    </div>
