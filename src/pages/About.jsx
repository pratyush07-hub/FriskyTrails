  ...
  return (
    <div className="min-h- mt-23 md:mt-28 lg:mt-30 xl:mt-28 w-full">
      <div className="hidden lg:block"
            ...
            >
              <h1 className="text-white text-8xl text-center pt-110 font-bold">Explore India With Us</h1>
</div>
      <div className="block lg:hidden"
            ...
            >
              <h1 className="text-white text-3xl text-center pt-60 font-bold">Explore India With Us</h1>
</div>
      ...
      <div className="">
        ...
        <div className="w-full md:w-[70vw] mx-auto flex justify-center">
          <p className="text-center mt-2 md:mt-8 text-base md:text-xl text-gray-600">
            <b>
              At FriskyTrails, we believe that travel isn't just about reaching
              a destination—
            </b>
            it's about the thrill of the journey, the experiences that shape us,
            and the stories we create along the way. Whether you're an
            adrenaline junkie, a nature lover, or someone looking to escape the
            ordinary, we bring you 100+ adventure activities and 500+ tour
